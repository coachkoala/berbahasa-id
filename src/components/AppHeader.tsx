    ...
    <header className="flex items-center justify-between border-b-[3px] border-[#111] bg-white px-4 py-3.5 sm:px-8 print:hidden">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link
          href="/app/settings"
          title={user?.email}
          className="flex h-[38px] w-[38px] items-center justify-center rounded-full border-[2.5px] border-[#111] bg-[#FFD100] font-[family-name:var(--font-display)] text-sm font-bold text-[#111]"
        >
          {initial}
        </Link>
      </div>
